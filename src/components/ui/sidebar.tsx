...
>(({ className, ...props }, ref) => {
  return (
    <main
      ref={ref}
      className={cn(
        "relative flex min-h-svh flex-1 flex-col bg-background flex-shrink-0",
    ...
    return (
        ...
        >
            <Link href="/competitions" className="flex items-center gap-2.5">
                ...
                {state === 'expanded' && <span className="text-lg font-bold">Kaggle Ingest</span>}
            </Link>
        </div>
    )
});
